...
(function(){var builder=function(cubism,Jolokia){var VERSION="1.2.3";var ctx_jolokia=function(url,opts){var source={},context=this,j4p=createAgent(url,opts),step=5e3;try
